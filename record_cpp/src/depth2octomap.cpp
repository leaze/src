...
const double camera_fx = 365.6061;
const double camera_fy = 365.6061;
...
int main(int argc, char **argv)
{
    ...
    image_transport::Subscriber sub = it.subscribe("/kinect2/hd/image_color_rect", 1, color_Callback);
    image_transport::Subscriber sub1 = it.subscribe("/kinect2/sd/image_depth_rect", 1, depth_Callback);
